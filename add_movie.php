...
<body>
    <h2>เพิ่มหนังใหม่</h2>
    <form method="POST" action="save_movie.php" enctype="multipart/form-data">
        ...
        <input type="number" name="movie_stock" placeholder="กรอกจำนวนคงเหลือ" required>

        <label>อัปโหลดโปสเตอร์:</label>
        <input type="file" name="movie_path" accept="image/*" required>
