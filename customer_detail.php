        ...
        <tbody>
            <?php while ($rent = $rent_result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <?php if ($rent['pickup_status'] == 'รอรับ'): ?>
                            <a href="confirm_pickup.php?rent_ID=<?= $rent['rent_ID']; ?>&customer_id=<?= $customer_id; ?>" class="btn btn-info">✔️ ยืนยันรับหนัง</a>
                            <?php elseif ($rent['pickup_status'] == 'รับแล้ว'): ?>
                            <span style="color: green;">รับสินค้าแล้ว</span>
                        <?php endif; ?>
                    </td>
                    <td>
